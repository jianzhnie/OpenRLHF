...
openrlhf.cli.train_ppo \
   --pretrain /home/ma-user/work/models/Qwen/Qwen2.5-1.5B \
   --critic_pretrain /home/ma-user/work/models/Qwen/Qwen2.5-1.5B \
   ...
   --init_kl_coef 0.01 \
   --use_kl_estimator_k3 \
   --prompt_data /home/ma-user/work/datasets/AI-MO/NuminaMath-TIR \
   --input_key problem \
   --label_key solution \
   --apply_chat_template \
   --max_samples 100000 \
